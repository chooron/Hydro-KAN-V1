...
p2 = plot_activation_functions(qnn_layer1_output, qnn_layer2_postacts_arr, [:mediumpurple, :mediumpurple, :mediumpurple])
...
tmp_p2_3 = begin
    plot(p2.series_list[7], bottom_margin=5Plots.mm)
    plot!(p2.series_list[8], bottom_margin=5Plots.mm)
    plot!(p2.series_list[9], bottom_margin=5Plots.mm)
end
p2_t = plot(tmp_p2_1, tmp_p2_2, tmp_p2_3, layout=(3, 1), size=(300, 900), dpi=300)
